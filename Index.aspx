    ...
    <div id=cubeTransition is=cp-page name=card>
      ...
      <div class='second page2'>
        ...
        <div class='box' v-suit=520,549>
          ...
          <!-- 标题 -->
          <img :class="is_show == 1 ? 'title st_title animated bounce': 'title st_title animated zoomOut' " src=content/img/second/title.png v-suit=518,234 />
          <img :class="is_show == 3 ? 'th_title title animated bounce' : 'th_title title animated zoomOut'" src=content/img/third/title.png v-suit=429,223 />
        </div>
...
<script src=scripts/index.js?101000100110></script>
...
<script src=scripts/function.js?3></script>
